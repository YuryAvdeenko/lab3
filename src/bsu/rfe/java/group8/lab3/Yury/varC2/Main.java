...
public class Main {
    ...
    Action searchValueAction = new AbstractAction("Найти значение многочлена") {
        public void actionPerformed(ActionEvent event) {
            ...
            String value = JOptionPane.showInputDialog(Main.this,
    ...
    Action searchRangeAction = new AbstractAction("Найти значение многочлена в диопазоне") {
        public void actionPerformed(ActionEvent event) {
            ...
            // Запросить пользователя ввести искомую строку
            String value1 = JOptionPane.showInputDialog(Main.this, "Введите значение начала отрезка",
                    "Поиск значения из диапазона", JOptionPane.QUESTION_MESSAGE);

            String value2 = JOptionPane.showInputDialog(Main.this, "Введите значение конца отрезка",
                    "Поиск значения из диапазона", JOptionPane.QUESTION_MESSAGE);
            // Установить введенное значение в качестве иголки
